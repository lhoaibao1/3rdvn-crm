...
>
    <x-filament::input.wrapper
        ...
        :x-on:focus-input.stop="$isNative ? '$el.querySelector(\'select\')?.focus()' : '$el.querySelector(\'.ts-control input\')?.focus()'"
        :attributes="
                    ...
                    {{
                        $extraInputAttributeBag
                            ->merge([
                                ...
                                'multiple' => $isMultiple,
                                'required' => $isRequired && (! $isConcealed),
                                'aria-required' => $isRequired && (! $isConcealed) ? 'true' : null,
                            ], escape: false)
                            ->class(['crm-searchable-select-native'])
                    }}
                    x-ref="input"
                ></select>
            </div>
