...
<main class="page"><div class="wrap">
    ...
    <section class="card">
        ...
        @else
        <form method="post" action="{{ route('feol.landing.store', ['token' => $integration->public_token]) }}" id="feol-form">
            @csrf
            <div class="grid">
                ...
                <div class="field full"><label>Mã giới thiệu</label><input name="referral_code" inputmode="numeric" maxlength="5" value="{{ old('referral_code', data_get($application->payload, 'fields.referral_code')) }}">@error('referral_code')<div class="error">{{ $message }}</div>@enderror</div>
