...
<title>510 — 3RD-VN System Status</title>
...
/* Runtime mapping for HTTP 510; original visual system preserved. */
#e501:checked ~ .page .error-code::before{content:"510"!important}
#e501:checked ~ .page .error-title::before{content:"Cần mở rộng yêu cầu"!important}
#e501:checked ~ .page .error-description::before{content:"Yêu cầu cần bổ sung phần mở rộng để được xử lý."!important}
</style>
</head>
...
<input class="state" type="radio" name="error" id="e501" checked>
