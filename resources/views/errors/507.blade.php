...
<title>507 — 3RD-VN System Status</title>
...
/* Runtime mapping for HTTP 507; original visual system preserved. */
#e503:checked ~ .page .error-code::before{content:"507"!important}
#e503:checked ~ .page .error-title::before{content:"Không đủ dung lượng lưu trữ"!important}
#e503:checked ~ .page .error-description::before{content:"Máy chủ chưa đủ dung lượng để hoàn tất yêu cầu."!important}
</style>
</head>
...
<input class="state" type="radio" name="error" id="e503" checked>
