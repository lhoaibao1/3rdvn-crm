...
<title>407 — 3RD-VN System Status</title>
...
/* Runtime mapping for HTTP 407; original visual system preserved. */
#e401:checked ~ .page .error-code::before{content:"407"!important}
#e401:checked ~ .page .error-title::before{content:"Cần xác thực proxy"!important}
#e401:checked ~ .page .error-description::before{content:"Kết nối trung gian yêu cầu thông tin xác thực hợp lệ."!important}
</style>
</head>
...
<input class="state" type="radio" name="error" id="e401" checked>
