...
<title>423 — 3RD-VN System Status</title>
...
/* Runtime mapping for HTTP 423; original visual system preserved. */
#e403:checked ~ .page .error-code::before{content:"423"!important}
#e403:checked ~ .page .error-title::before{content:"Tài nguyên đang bị khóa"!important}
#e403:checked ~ .page .error-description::before{content:"Dữ liệu hiện được khóa bởi một tiến trình hoặc quy trình khác."!important}
</style>
</head>
...
<input class="state" type="radio" name="error" id="e403" checked>
