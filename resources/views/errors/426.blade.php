...
<title>426 — 3RD-VN System Status</title>
...
/* Runtime mapping for HTTP 426; original visual system preserved. */
#e405:checked ~ .page .error-code::before{content:"426"!important}
#e405:checked ~ .page .error-title::before{content:"Cần nâng cấp giao thức"!important}
#e405:checked ~ .page .error-description::before{content:"Vui lòng sử dụng giao thức hoặc phiên bản kết nối mới hơn."!important}
</style>
</head>
...
<input class="state" type="radio" name="error" id="e405" checked>
