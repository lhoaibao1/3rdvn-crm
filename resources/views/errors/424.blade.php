...
<title>424 — 3RD-VN System Status</title>
...
/* Runtime mapping for HTTP 424; original visual system preserved. */
#e409:checked ~ .page .error-code::before{content:"424"!important}
#e409:checked ~ .page .error-title::before{content:"Tác vụ phụ thuộc thất bại"!important}
#e409:checked ~ .page .error-description::before{content:"Yêu cầu không thể hoàn tất vì một tác vụ liên quan đã thất bại."!important}
</style>
</head>
...
<input class="state" type="radio" name="error" id="e400">
...
<input class="state" type="radio" name="error" id="e409" checked>
