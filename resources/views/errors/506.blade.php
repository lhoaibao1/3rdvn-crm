...
<title>506 — 3RD-VN System Status</title>
...
/* Runtime mapping for HTTP 506; original visual system preserved. */
#e500:checked ~ .page .error-code::before{content:"506"!important}
#e500:checked ~ .page .error-title::before{content:"Lỗi thương lượng nội dung"!important}
#e500:checked ~ .page .error-description::before{content:"Cấu hình máy chủ gây xung đột khi lựa chọn nội dung phản hồi."!important}
</style>
</head>
...
<input class="state" type="radio" name="error" id="e500" checked>
