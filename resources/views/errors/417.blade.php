...
<title>417 — 3RD-VN System Status</title>
...
/* Runtime mapping for HTTP 417; original visual system preserved. */
#e400:checked ~ .page .error-code::before{content:"417"!important}
#e400:checked ~ .page .error-title::before{content:"Không thể đáp ứng kỳ vọng"!important}
#e400:checked ~ .page .error-description::before{content:"Máy chủ không thể đáp ứng điều kiện Expect của yêu cầu."!important}
</style>
</head>
