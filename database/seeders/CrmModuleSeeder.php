...
class CrmModuleSeeder extends Seeder
{
    public function run(): void
    {
        $modules = [
            ...
            ['name' => 'Users', 'slug' => 'users', 'label' => 'Người dùng', 'icon' => 'users', 'route_name' => 'users.index', 'sort_order' => 60, 'required_permissions' => ['user.view'], 'required_roles' => ['Admin', 'ZD', 'AM', 'Team Leader', 'Courier Manager']],
